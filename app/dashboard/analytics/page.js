        ...
        {analytics?.totalReports > 0 ? (
          <>
            ...
            <div className="bg-card border-minimal rounded-lg p-6">
              <h3 className="text-lg font-semibold font-heading text-foreground mb-4 text-center md:text-left">Report Summary</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm font-body text-center md:text-left">
                <div>
          ...
          <div className="bg-card border-2 border-electric-yellow/20 rounded-lg p-12 text-center max-w-2xl mx-auto mt-12">
            ...
            <h2 className="text-2xl font-bold font-heading text-foreground mb-2">Dashboard Empty</h2>
            <p className="text-muted-foreground text-lg font-body mb-6">No reports have been processed yet. Upload your first inspection report to generate comprehensive analytics.</p>
            <Button onClick={() => router.push('/')} className="bg-electric-yellow hover:bg-electric-yellow/90 text-slate-950 font-medium">
              Upload New Report
            </Button>
          </div>
        )}
