 ...
 * Uses Claude 3.5 Sonnet for intelligent data merging and conflict detection
 */
...
Return ONLY the JSON object, no other text.`;
    ...
    // Ensure dataConflicts array exists
    if (!mergedData.dataConflicts) {
      mergedData.dataConflicts = [];
    }
